...
const DualChartVisualization: React.FC<DualChartVisualizationProps> = ({ 
    ...
    const formatDate = (dateString: string) => {
        ...
        if (period === 'Diario') {
            ...
            // Mostrar "Hoy", "Mañana" o día de la semana
    ...
    // Preparar datos históricos (últimos 30 días para mejor visualización)
    ...
    const maxForecast = Math.max(...forecastData.map(d => d.precipitation));
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-slate-800/50 p-6 rounded-xl border border-slate-700">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <h4 className="text-lg font-semibold text-white">Predicción {period}</h4>
                    ...
                    <div className="mt-3 flex items-center justify-between text-sm">
                        <span className="text-slate-400">Promedio: {(forecastData.reduce((sum, d) => sum + d.precipitation, 0) / forecastData.length).toFixed(1)} mm</span>
